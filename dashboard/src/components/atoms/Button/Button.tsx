  ...
  ({ className, variant = 'primary', size = 'md', fullWidth = false, isLoading, children, disabled, ...props }, ref) => {
    return (
      <button
        ...
        className={cn(
          'inline-flex items-center justify-center gap-2 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer',
          ...
          variant === 'outline'     && 'border border-slate-200 bg-transparent text-slate-700 hover:bg-slate-100 focus:ring-slate-400 dark:bg-white',
